#define GLEW_STATIC
#ifndef FontWriterFuncs
#define FontWriterFuncs
...
class ScreenWriter
{
	...
	ScreenWriter(string font,float swidth,float sheight)
		{Setup(font,swidth,sheight);};

	void Setup(string font,float swidth,float sheight)
	{
    		// FreeType
    		FT_Library ft;
		...
		else {cout << "FREETYPE: FreeType initiated." << endl;}

    		// Load font as face
    		FT_Face face;
    		if (FT_New_Face(ft, font.c_str(), 0, &face))
    		    {cout << "ERROR::FREETYPE: Failed to load font" << endl;}
		else {cout << "FREETYPE: Font loaded." << endl;}
